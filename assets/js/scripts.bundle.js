                ...
                var KTImageInput = function (element, options) {
                    ...
                    var _change = function (e) {
                        ...
                        if (the.inputElement !== null && the.inputElement.files && the.inputElement.files[0]) {
                            ...
                            const file = the.inputElement.files[0]?.name
                            const extension = file.replace(/^.*\./, '');
                            const checkImageExt = [{
                                name: 'txt',
                                image: `https://cdn-icons-png.flaticon.com/512/4726/4726030.png`,
                            }, {
                                name: 'xls',
                                ...
                                name: 'doc',
                                image: `https://cdn-icons-png.flaticon.com/512/4725/4725970.png`
                            }, {
                                name: 'docx',
                                image: `https://cdn-icons-png.flaticon.com/512/4725/4725970.png`
                            }, {
                                name: 'pdf',
                                image: `https://cdn-icons-png.flaticon.com/512/4726/4726010.png`
                            }].find(({
                                name
                            }) => name === extension);
                            ...
                            reader.onload = function (e) {
                                // `${BASE_URL}assets/image/blank-image.svg`
                                const image = checkImageExt?.image ?? e.target.result
                                KTUtil.css(the.wrapperElement, 'background-image', 'url(' + image + ')');
