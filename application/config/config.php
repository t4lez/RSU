...
*/
//$config['base_url'] = '';
$ss = isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : 'CLI';
$root = (isset($_SERVER['HTTPS']) ? "https://" : "http://") . $ss;
//$root=(isset($_SERVER['HTTPS']) ? "https://" : "http://").$_SERVER['HTTP_HOST'];
$root .= str_replace(basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME']);
$config['base_url'] = $root;

$config['data_path'] = FCPATH . 'uploads/';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
|
*/
//$config['language']	= 'indonesia';//'english';
...
$config['encryption_key'] = md5($config['base_url']);
...
/*$config['modules_locations'] = array(
	...
	APPPATH . $modules_location .'/client/' => '../'.$modules_location.'/client/', 
